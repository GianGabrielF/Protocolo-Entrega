...
#
get_filename_component(filename "/home/msobral/CLionProjects/serial_com/cmake-build-debug/_deps/serialpp-tmp/v1.0.0.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/msobral/CLionProjects/serial_com/cmake-build-debug/_deps/serialpp-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-serialpp${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-serialpp${i}")
